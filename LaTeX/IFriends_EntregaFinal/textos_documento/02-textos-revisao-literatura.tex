...
A partir da discussão iniciada no estudo de \citeonline{sartori2004comunidades} sobre as redes virtuais de aprendizado, toma-se como base a definição da construção de comunidades em torno de tais características como manifestações dos agrupamentos humanos no ciberespaço. \citeonline{sartori2004comunidades} dão continuidade na introdução ao assunto, quando explicam o funcionamento da construção inicial de comunidades virtuais:
\begin{citacao}
...
Dentro deste cenário, é possível tentar compreender algumas das formas de estímulo para que a socialidade característica das comunidades virtuais se manifeste. Desse modo, o autor \citeonline{kratochwill2006possibilidades} descreve como exemplo a utilização de fóruns de discussão como parte do processo.
